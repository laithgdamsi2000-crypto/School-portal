...
function SearchPageContent() {
  ...
  return (
    <div>
      <PageHeader title="البحث" maxWidth="max-w-4xl" />
              ...
              <div className="flex flex-col gap-3">
                {results.announcements.map((a) => (
                  <Link
                    ...
                    className="bg-white border border-navy-50 rounded-card p-5 hover:shadow-card-hover hover:-translate-y-0.5 transition duration-300"
                  >
